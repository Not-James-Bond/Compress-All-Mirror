...
task.start()
    ...
    var template, newSignature;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, api.getSignatureTemplate(task.id)];
            case 1:
                template = _a.sent();
                newSignature = api.newTask('sign');
                return [4 /*yield*/, newSignature.start()];
            case 2:
                _a.sent();
                return [4 /*yield*/, newSignature.processFromTemplate(template)];
            case 3:
                _a.sent();
                return [2 /*return*/];
        }
